...
const COLUMNS: TableColumn[] = [
  ...
  { field: 'status', header: "Status", sortable: true, filterType: 'radio', filterOptions: [{ label: "Draft", value: "0" }, { label: "Sent", value: "1" }, { label: "PartiallyDelivered", value: "2" }, { label: "Delivered", value: "3" }, { label: "Cancelled", value: "4" }], html: (row: Record<string, unknown>) => { const m: Record<string, string> = {["0"]: "Draft", ["1"]: "Sent", ["2"]: "PartiallyDelivered", ["3"]: "Delivered", ["4"]: "Cancelled"}; return m[String(row.status ?? '')] ?? String(row.status ?? '\u2014'); } },
