...
using director3.Authorization;
using director3.Entities;

namespace director3.EntityFrameworkCore.Seed
{
    /// <summary>
    ...
    public class DefaultUserSeeder
    {
        ...
        public void Seed()
        {
            ...
            try
            {
                ...
                {
                    customRole_0 = new AppRole { Name = "Requester", DisplayName = "Talep Eden", Description = "Satın alma talebi oluşturur, kalemlerini ve teklifleri ekler, kendi taleplerini takip eder.", IsSystem = false, IsActive = true };
                ...
                var customPerms_0 = new string[] { "PurchaseRequest.Create", "PurchaseRequest.Read", "PurchaseRequest.Update", "PurchaseRequestItem.Create", "PurchaseRequestItem.Read", "PurchaseRequestItem.Update", "PurchaseRequestItem.Delete", "Quotation.Create", "Quotation.Read", "Quotation.Update", "Quotation.Delete" };
                ...
                {
                    customRole_1 = new AppRole { Name = "DepartmentManager", DisplayName = "Birim Müdürü", Description = "DepartmentManager rolündeki herhangi bir kullanıcı, birimin satın alma taleplerini inceler, onaylar veya gerekçe göstererek reddeder.", IsSystem = false, IsActive = true };
                ...
                {
                    customRole_2 = new AppRole { Name = "FinanceApprover", DisplayName = "Finans Onaycısı", Description = "Birim müdürü onayından geçmiş talepleri finansal açıdan değerlendirir ve nihai onayı verir.", IsSystem = false, IsActive = true };
                ...
                {
                    customRole_3 = new AppRole { Name = "PurchasingOfficer", DisplayName = "Satın Alma Sorumlusu", Description = "Onaylanmış talepler için tedarikçi tekliflerini yönetir, siparişi oluşturur ve teslimat sürecini takip eder.", IsSystem = false, IsActive = true };
