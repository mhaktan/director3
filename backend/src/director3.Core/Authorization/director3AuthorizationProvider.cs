...
namespace director3.Authorization
{
    public class director3AuthorizationProvider : AuthorizationProvider
    {
        ...
        {
            return new LocalizableString(name, director3Consts.LocalizationSourceName);
        }
    }
}
