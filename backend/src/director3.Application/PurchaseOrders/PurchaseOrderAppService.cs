...
namespace director3.PurchaseOrders
{
        ...
        IPurchaseOrderAppService
    {
        ...
        public async Task<PurchaseOrderDto> ChangeStatusAsync(long id, ChangeStatusInput input)
        {
            ...
            {
            ("Draft", "Sent", "Send", false),
            ("Sent", "PartiallyDelivered", "MarkPartialDelivery", false),
            ("Sent", "Delivered", "MarkDelivered", false),
            ("PartiallyDelivered", "Delivered", "MarkDelivered", false),
