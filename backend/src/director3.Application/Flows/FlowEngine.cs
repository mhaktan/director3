                ...
                switch (node.Type)
                {
                    ...
                    case "approval":
                        ...
                        try
                        {
                            ...
                            var appServiceType = System.Type.GetType("director3.Approvals.IApprovalAppService, director3.Application")
                                ?? throw new InvalidOperationException("IApprovalAppService type not found in director3.Application assembly");
                            ...
                            var submitInputType = System.Type.GetType("director3.Approvals.Dto.SubmitApprovalInput, director3.Application")!;
