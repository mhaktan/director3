...
using director3.PurchaseOrders;
using director3.PurchaseOrders.Dto;
using director3.Flows;

namespace director3.Tests.PurchaseOrders
{
    public class PurchaseOrderAppServiceTests
    {
        ...
        public PurchaseOrderAppServiceTests()
        {
            ...
            _service = new PurchaseOrderAppService(_repositoryMock.Object, new Mock<IFlowEngine>().Object, new Mock<IRepository<StatusChangeLog, long>>().Object);
        }
